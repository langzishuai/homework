...
namespace prac_3_6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            myService.Export("D:\\practice_c#\\prac_3_6\\s.xml");
            List<Order> myOrderList = myService.Import("D:\\practice_c#\\prac_3_6\\s.xml");
    ...
    public class Order:IComparable
    {
        ...
        public Order() { Id = -1;Customer = "";TotalAmount = 0; List_orderitem = new List<OrderItem>(); }
